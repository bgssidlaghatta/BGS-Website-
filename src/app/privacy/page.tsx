    ...
    <div className="min-h-screen bg-brand-cream paper-texture pt-32 pb-20">
      <div className="px-6 md:px-12 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg text-brand-umber/80 leading-relaxed bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-brand-maroon/5">
          ...
          <h2 className="text-2xl font-serif font-bold text-white mt-10 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-serif font-bold text-white mt-10 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-serif font-bold text-white mt-10 mb-4">3. Data Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-white mt-10 mb-4">4. Sharing Your Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-white mt-10 mb-4">5. Contact Us</h2>
          <p>
            If you have questions or comments about this Privacy Policy, please contact us at:
          </p>
          <div className="bg-brand-offwhite p-6 rounded-xl mt-4 border border-brand-maroon/10">
            <p className="font-semibold text-white mb-1">BGS Public School & PU College</p>
