    ...
    <div className="min-h-screen bg-brand-cream paper-texture pt-32 pb-20">
      <div className="px-6 md:px-12 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg text-brand-umber/80 leading-relaxed bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-brand-maroon/5">
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-maroon mt-10 mb-4">1. Use of Website</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-maroon mt-10 mb-4">2. Intellectual Property Rights</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-maroon mt-10 mb-4">3. Accuracy of Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-maroon mt-10 mb-4">4. Admissions and Forms</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-brand-maroon mt-10 mb-4">5. Governing Law</h2>
          <p>
